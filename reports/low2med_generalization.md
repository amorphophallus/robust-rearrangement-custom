...
| 2 | rgbd+only skill | misunderstood-firebrand-6 | SKILL=true | round_table |
...
| rgbd+only skill | misunderstood-firebrand-6 | 8.33% (1/12) | 0.00% (0/1) |
...
|---------|--------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| rgbd+gp | dauntless-breeze-2 | 66.67% (8/12) | 75.00% (6/8) | 33.33% (2/6) | 100.00% (2/2) | 100.00% (2/2) | 100.00% (2/2) | 50.00% (1/2) | — | — |
| rgbd+only skill | misunderstood-firebrand-6 | 91.67% (11/12) | 45.45% (5/11) | 40.00% (2/5) | 100.00% (2/2) | 0.00% (0/1) | 100.00% (1/1) | 100.00% (1/1) | 0.00% (0/1) | — |
| rgbd+gp+skill | vocal-bush-11 | 83.33% (10/12) | 40.00% (4/10) | 25.00% (1/4) | 100.00% (1/1) | 100.00% (1/1) | 0.00% (0/1) | — | — | — |
| rgbd+colored gp | gentle-fog-7 | 91.67% (11/12) | 63.64% (7/11) | 42.86% (3/7) | 100.00% (3/3) | 100.00% (3/3) | 100.00% (3/3) | 33.33% (1/3) | 100.00% (1/1) | — |
...
| rgbd+only skill | misunderstood-firebrand-6 | 0428 | `...0428_misunderstood-firebrand-6_last_.pt` | rgbd-only-skill | False | True | False * |
...
## Appendix B: JSON Provenance

Paths below are relative to `/home/huyue/projects/robust-rearrangement-custom/logs/evaluate_model/`.

### MT-BC med eval

| Condition | RUN_ID | one_leg JSON | round_table JSON | lamp JSON | aggregate JSON |
|---------|--------|--------------|------------------|-----------|----------------|
| rgbd+gp | autumn-dust-13 | `one_leg/multi-task-rgbd-skill-low-0610_autumn-dust-13_latest_3000/2026-06-27T00-08-45.json` | `round_table/multi-task-rgbd-skill-low-0610_autumn-dust-13_latest_3000/2026-06-27T00-17-32.json` | `lamp/multi-task-rgbd-skill-low-0610_autumn-dust-13_latest_3000/2026-06-27T00-26-25.json` | `one_leg+round_table+lamp/multi-task-rgbd-skill-low-0610_autumn-dust-13_latest_3000/2026-06-27T00-26-26.json` |
| rgbd+gp+skill | fresh-tree-11 | `one_leg/multi-task-rgbd-skill-low-0610_fresh-tree-11_latest_3000/2026-06-27T00-34-17.json` | `round_table/multi-task-rgbd-skill-low-0610_fresh-tree-11_latest_3000/2026-06-27T00-43-13.json` | `lamp/multi-task-rgbd-skill-low-0610_fresh-tree-11_latest_3000/2026-06-27T00-51-38.json` | `one_leg+round_table+lamp/multi-task-rgbd-skill-low-0610_fresh-tree-11_latest_3000/2026-06-27T00-51-39.json` |
| rgbd+colored gp | absurd-voice-2 | `one_leg/multi-task-rgbd-skill-low-0610_absurd-voice-2_latest_3000/2026-06-27T00-59-40.json` | `round_table/multi-task-rgbd-skill-low-0610_absurd-voice-2_latest_3000/2026-06-27T01-08-14.json` | `lamp/multi-task-rgbd-skill-low-0610_absurd-voice-2_latest_3000/2026-06-27T01-16-34.json` | `one_leg+round_table+lamp/multi-task-rgbd-skill-low-0610_absurd-voice-2_latest_3000/2026-06-27T01-16-35.json` |
...
| Condition | RUN_ID | round_table JSON |
|---------|--------|------------------|
| rgbd+gp | dauntless-breeze-2 | `round_table/multi-task-rgbd-skill-low-0428_dauntless-breeze-2_last/2026-06-27T02-31-19.json` |
| rgbd+only skill | misunderstood-firebrand-6 | `round_table/multi-task-rgbd-skill-low-0428_misunderstood-firebrand-6_last/2026-06-27T02-40-08.json` |
| rgbd+gp+skill | vocal-bush-11 | `round_table/multi-task-rgbd-skill-low-500_vocal-bush-11_last/2026-06-27T02-49-02.json` |
| rgbd+colored gp | gentle-fog-7 | `round_table/multi-task-rgbd-skill-low-0428_gentle-fog-7_last/2026-06-27T02-57-49.json` |
| rgbd | breezy-rain-3 | `round_table/multi-task-rgbd-skill-low-0428_breezy-rain-3_last/2026-06-27T03-06-26.json` |
| rgb | fiery-snowball-4 | `round_table/multi-task-rgbd-skill-low-0428_fiery-snowball-4_last/2026-06-27T03-15-18.json` |

### RPPO med eval

| Task | JSON |
|------|------|
| one_leg | `one_leg/actor_chkpt/2026-06-27T02-20-59.json` |
| round_table | `round_table/actor_chkpt/2026-06-27T02-21-51.json` |
| lamp | `lamp/actor_chkpt/2026-06-27T02-21-54.json` |
