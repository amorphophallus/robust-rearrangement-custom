...
def generate_vlm_cover_108_report(
    *, manifest_path: Path, legacy_manifest_path: Path, report_path: Path,
    ...
    rel_numeric_pdf = rel_numeric.with_suffix(".pdf")
    rel_tracking_pdf = rel_tracking.with_suffix(".pdf")
    rel_three_task_success_pdf = rel_three_task_success.with_suffix(".pdf")
    rel_three_task_tracking_pdf = rel_three_task_tracking.with_suffix(".pdf")
    lines = [
        ...
        f"[矢量 PDF]({rel_numeric_pdf.as_posix()})", "",
        ...
        f"[矢量 PDF]({rel_three_task_tracking_pdf.as_posix()})", "",
        ...
        f"[矢量 PDF]({rel_three_task_success_pdf.as_posix()})", "",
        f"![Task-by-metric tracking breakdown]({rel_tracking.as_posix()})", "",
        f"[矢量 PDF]({rel_tracking_pdf.as_posix()})", "",
        ...
        f"[矢量 PDF]({Path(os.path.relpath(skill_figures['skill_success_rate'].with_suffix('.pdf'), report_path.parent)).as_posix()})", "",
        "Position error", "",
        f"![Skill-level position tracking error]({Path(os.path.relpath(skill_figures['tracking_position'], report_path.parent)).as_posix()})", "",
        f"[矢量 PDF]({Path(os.path.relpath(skill_figures['tracking_position'].with_suffix('.pdf'), report_path.parent)).as_posix()})", "",
        "Orientation error", "",
        ...
        f"[矢量 PDF]({Path(os.path.relpath(skill_figures['tracking_orientation'].with_suffix('.pdf'), report_path.parent)).as_posix()})", "",
        "Total error", "",
        f"![Skill-level total tracking error]({Path(os.path.relpath(skill_figures['tracking_total'], report_path.parent)).as_posix()})", "",
        f"[矢量 PDF]({Path(os.path.relpath(skill_figures['tracking_total'].with_suffix('.pdf'), report_path.parent)).as_posix()})", "",
